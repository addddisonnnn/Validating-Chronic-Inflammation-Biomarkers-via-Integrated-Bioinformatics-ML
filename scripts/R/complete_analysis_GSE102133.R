# Save as: complete_analysis_GSE102133.R
...
# Set paths
cel_path <- "/projectnb/bf528/students/addisony/project1/Validating-Chronic-Inflammation-Biomarkers-via-Integrated-Bioinformatics-ML-Paper/data/raw/GSE102133"
output_dir <- "/projectnb/bf528/students/addisony/project1/Validating-Chronic-Inflammation-Biomarkers-via-Integrated-Bioinformatics-ML-Paper/results/GSE102133"
...
group_info <- read.csv("GSE102133_sample_groups.csv")
...
output_file <- file.path(output_dir, "GSE102133_normalized_gene_expression.csv")
...
# 10. Save DEG results
deg_file <- file.path(output_dir, "GSE102133_DEGs.csv")
...
summary_file <- file.path(output_dir, "GSE102133_analysis_summary.csv")
